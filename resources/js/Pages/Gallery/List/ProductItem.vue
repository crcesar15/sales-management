<template>
  ...
  >
    ...
    <div>
      ...
      />
      <div v-else class="flex flex-wrap justify-center items-center border-round shadow-2" style="height: 200px; width: 200px">
        <p>
          <i class="fa fa-image" />
          No images yet
        </p>
    ...
    <p class="text-sm pr-3 pl-3" style="min-height: 100px">
      {{ product.description }}
    </p>
    <div class="flex w-full">
      <PButton label="View" icon="fa fa-eye" class="w-full m-2" text raised />
      <PButton label="Edit" icon="fa fa-edit" class="w-full m-2" text raised severity="secondary" />
    </div>
  </div>
</template>
