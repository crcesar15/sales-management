...
namespace Barryvdh\Debugbar\Facades {
     ...
     */
    final class Debugbar extends \DebugBar\DebugBar
    {
        /**
         ...
         *
         * @param  string  $name  Internal name, used to stop the measurement
        ...
        /**
         * Utility function to measurement the execution of a Closure
         *
         * @param  string  $label
         * @param  \Closure  $closure
         * @param  string|null  $collector
         ...
         * @static
         */
        public static function measurement($label, $closure, $collector = null, $group = null)
        {
            /** @var \Barryvdh\Debugbar\LaravelDebugbar $instance */
            return $instance->measurement($label, $closure, $collector, $group);
        }
...
namespace Illuminate\Routing {
    ...
    final class Router
    {
        ...
        public static function inertia($uri, $component, $props = [])
        {
            return self::inertia($uri, $component, $props);
        }
...
namespace Illuminate\Testing {
    ...
    final class TestResponse
    {
        ...
        {
            return self::assertInertia($callback);
        }
...
namespace {
    ...
    final class Debugbar extends Barryvdh\Debugbar\Facades\Debugbar {}
    final class Flare extends Spatie\LaravelIgnition\Facades\Flare {}
}
